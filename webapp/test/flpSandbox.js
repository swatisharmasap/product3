		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product3",
									"targetURL": "#sapcomproduct3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomproduct3-display": {
								"semanticObject": "sapcomproduct3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.product3",
									"url": sap.ui.require.toUrl("sap/com/product3")
								}
							}
						}
					}
